...
const AddBook = () => {
    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-blue-100 to-amber-200'>
            <Link to="/" className='block text-sm text-blue-600 hover:underline m-4'>⬅ Home Page</Link>

            <div className='flex flex-col items-center justify-center'>
                <h1 className='font-bold text-3xl mb-4'>Add Book</h1>
                <form className='flex flex-col gap-4 bg-grey-200 p-6 rounded-xl shadow-md w-[90%] max-w-md'>
